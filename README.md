...
- Semanas completas de lunes a domingo, incluso al cruzar meses/años. Lo cobrado proviene de `income`; salario estimado = horas × tarifa actual y se muestra aparte. Cambiar la tarifa recalcula estimaciones históricas, como en la versión original. Las propinas ligadas se cuentan una sola vez.
- Flujo semanal = ingresos registrados menos gastos pagados. Incluye todas las áreas al seleccionar Todos. El presupuesto semanal Personal respeta `spread`, sin confundir el reparto presupuestario con el pago real.
